...
class Room_model extends CI_Model
{
   ...
   //     var_dump($this->getRommTypeCountAndPrice());
//        $a=($this->getRommTypeCountAndPrice());
//        var_dump($a['total']);
    }
    ...
    public function getRommTypeCountAndPrice($time=null)
    {
        ...
        {
//            $sql.=", ";
//            $sql.=" SUM(CASE WHEN room=$key THEN score1 ELSE 0 END) as s1sum$key ";
//            $sql.=", ";
//            $sql.=" SUM(CASE WHEN room=$key THEN score2 ELSE 0 END) as s2sum$key ";
//            $sql.=", ";
//            $sql.=" SUM(CASE WHEN room=$key THEN score3 ELSE 0 END) as s3sum$key ";
            $sql.=", ";
    ...
    {
        $sql=" SELECT count(*) as total FROM `room_round`";
        $query = $this->db->query($sql);
